...
insert into users (username, password, first_name, last_name, phone_number, email, enabled) values ('zelimir', '$2a$04$Vbug2lwwJGrvUXTj6z7ff.97IzVBkrJ1XfApfGNl.Z695zqcnPYra', 'Zelimir', 'Zulov', '0601231235', 'bskokic@outlook.com', TRUE);
...
insert into location(name, description, deleted, email, ticket_price)	values ('Đavolja Varoš', 'Đavolja Varoš je nesvakidašnji prizor zemljanih kupa, koje su po narodnom predanju okamenjeni svatovi koji su slušajući đavola pošli da venčaju brata i sestru. Pored reljefa, Đavolju Varoš čine i dva izvora kisele vode.', FALSE, 'bskokic@outlook.com', 1100);
insert into location(name, description, deleted, email, ticket_price)	values ('Babin Zub', 'Napredni snowboarder i skijaš početnik – naš tim za zimske sportove je prilično raznolik', FALSE, 'bskokic@outlook.com', 500);
insert into location(name, description, deleted, email, ticket_price)	values ('Zlatar', 'Napredni snowboarder i skijaš početnik – naš tim za zimske sportove je prilično raznolik', FALSE, 'bskokic@outlook.com', 0);
insert into location(name, description, deleted, email, ticket_price)	values ('Visoka Planina', 'Napredni snowboarder i skijaš početnik – naš tim za zimske sportove je prilično raznolik', FALSE, 'bskokic@outlook.com', 350);
insert into location(name, description, deleted, email, ticket_price)	values ('Lokacija za brisanje', 'Napredni snowboarder i skijaš početnik – naš tim za zimske sportove je prilično raznolik', FALSE, 'bskokic@outlook.com', 1200);
...
insert into excursion(cancelled, date, max_number_of_persons, price, tour_guide_id) values (FALSE, '2022-11-21', 80, 100, 1);
